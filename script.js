...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.education-card, .skill-category, .timeline-content, .project-card, .achievement-card, .certification-card, .contact-item');
